...
auto ItemDrops::onRender(RenderUtils* r) -> void {
    ...
    for(auto [runtimeId, entity] : this->getManager()->getEntityMap()) {
        ...
        auto text = entity->getEntityType();
